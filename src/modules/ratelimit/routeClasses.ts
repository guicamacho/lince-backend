...
export const ROUTE_CLASSMAP: Record<string, RouteClass> = {
  ...
  "POST /app/payouts": "ticket",
  "GET /app/transactions": "reads",
  "GET /app/balances": "reads",
  "GET /app/balance-history": "reads",
  "GET /app/rates": "reads",
  "GET /app/beneficiaries": "reads",
  "POST /app/beneficiaries": "beneficiary_write",
  "PATCH /app/beneficiaries/:id": "beneficiary_write",
  "POST /app/disputes": "beneficiary_write",
  "GET /app/team": "reads",
  ...
  "GET /admin/beneficiaries/reverification": "admin_export",
  "POST /admin/beneficiaries/:id/verify": "admin_export",
  "POST /admin/orgs/:id/reveal-cnpj": "admin_export",
